function Get-iBossAllowList {
    <#
    .SYNOPSIS
        Retrieves the 'Allow List' controls from the iBoss Gateway with pagination support.

    .DESCRIPTION
        Retrieves the Allow List entries.
    ...
    .EXAMPLE
        Get-iBossAllowList -All
        # Returns every entry in the list.

    .EXAMPLE
        Get-iBossAllowList -MaxItems 50 -CurrentRow 100
